...
class EMI_Trainer:
    def __init__(self, numTimeSteps, numOutput, graph=None,
        ...
        # Input validation
        self.supportedLosses = ['xentropy', 'l2','huber']
    ...
    def __createLossOp(self, predicted, target):
        '''
            Loss Operation that implements the MI-RNN loss function, i.e. EMI-RNN Paper, Eqn (3.1.1)
        '''
        ...
        with tf.name_scope(self.scope):
            ...
            if self.lossType == 'xentropy':
                ...
                lossOp = tf.losses.huber_loss(labels = labels__,predictions=logits__)
        return lossOp
    ...
    def run(self, numClasses, x_train, y_train, bag_train, x_val, y_val,
        ...
        *args, **kwargs: Additional arguments passed to callback methods and
        ...
        for cround in range(numRounds):
            ...
            '''
                Using the EMI-RNN loss function.
            '''
            if cround == emiStep:
